...
Generate an empty NuGet package and temporarily publish to nuget.org in order to reserve a package name.
...
The name of package to be reserved on nuget.org
...
if ($publish) {
    ...
    Write-Host "Skipping publish. Re-run with -publish to push to nuget.org"
}
popd
