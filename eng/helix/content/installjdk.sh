...
output_dir="$DIR/java"
url="https://netcorenativeassets.blob.core.windows.net/resource-packages/external/linux/java/microsoft-jdk-${java_version}-${platformarch}.tar.gz"
...
tar --strip-components 1 -xzf "microsoft-jdk-${java_version}-${platformarch}.tar.gz" --no-same-owner --directory "$output_dir"
