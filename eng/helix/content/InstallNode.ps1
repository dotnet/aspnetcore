 <#
 .SYNOPSIS
     Installs Node.js from http://nodejs.org/dist on a machine
 .DESCRIPTION
     This script installs Node.js from http://nodejs.org/dist on a machine.
 .PARAMETER Version
...
Write-Host "Done downloading Node.js ${Version}"
