...
$webClient.DownloadFile('https://raw.githubusercontent.com/meyerrj/Home/master/kvm.ps1', $kvmPs1Path)
Write-Host "Downloading KVM.cmd to $kvmCmdPath"
$webClient.DownloadFile('https://raw.githubusercontent.com/meyerrj/Home/master/kvm.cmd', $kvmCmdPath)
