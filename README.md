# Getting Started with ASP.NET Core and DNX
...
This guide is designed to get you started building applications with the latest development versions ASP.NET Core and DNX. This means nightly builds and potentially broken or unstable packages.
