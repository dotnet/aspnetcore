...
#### Windows
To install KVM on Windows run one of the following commands (depending on your default command shell), which will download and run a script that installs KVM for the current user (requires admin privileges):
