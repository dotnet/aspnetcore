    ...
    public class RoutePatternMatcherTests
    {
        ...
        public void TryMatch_WithUrlWithMultiSegmentWithRepeatedDots()
        {
            RunTest(
                ...
                "/Home..mvc/123/p1",
                null,
                new DispatcherValueCollection(new { Controller = "Home", id = "123", Param1 = "p1" }));
        }
        ...
        public void TryMatch_WithUrlWithTwoRepeatedDots()
        {
            RunTest(
                ...
                "/Home.mvc/../index",
                null,
                new DispatcherValueCollection(new { Controller = "Home", action = "index" }));
        }
        ...
        public void TryMatch_WithCatchAllCapturesDots()
        {
            ...
            RunTest(
                ...
                new DispatcherValueCollection(new { controller = "Home", action = "ShowPilot", missionId = "777", name = "12345./foobar" }));
        }
        ...
        public void TryMatch_RouteWithCatchAll_MatchesEmptyContent_DoesNotReplaceExistingRouteValue()
        {
            ...
            var values = new DispatcherValueCollection(new { p2 = "hello" });
        ...
        public void TryMatch_RouteWithCatchAll_UsesDefaultValueForEmptyContent()
        {
            ...
            var values = new DispatcherValueCollection(new { p2 = "overridden" });
        ...
        public void TryMatch_WithWeimatchParameterNames()
        {
            RunTest(
                ...
                new DispatcherValueCollection() { { " ", "not a space" }, { "op.tional", "default value" }, { "ran!dom", "va@lue" } },
                new DispatcherValueCollection() { { " ", "space" }, { ".!$%", "weimatch" }, { "dynamic.data", "omatcherid" }, { "op.tional", "default value" }, { "ran!dom", "va@lue" } });
        }
        ...
        public void TryMatch_MatchesRouteWithLiteralSeparatomatchefaultsAndValue()
        {
            RunTest(
                ...
                "/foo/xx-yy",
                new DispatcherValueCollection(new { language = "en", locale = "US" }),
                new DispatcherValueCollection { { "language", "xx" }, { "locale", "yy" }, { "controller", "foo" } });
        }
