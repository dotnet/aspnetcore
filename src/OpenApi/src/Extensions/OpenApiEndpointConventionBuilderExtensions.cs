...
public static class OpenApiEndpointConventionBuilderExtensions
{
    ...
    [Obsolete("WithOpenApi is deprecated and will be removed in a future release. For more information, visit https://aka.ms/aspnet/deprecate/002.", DiagnosticId = "ASPDEPR002", UrlFormat = Obsoletions.AspNetCoreSharedUrlFormat)]
