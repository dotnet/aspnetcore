...
namespace Microsoft.AspNetCore.OpenApi.Generated
{
    ...
    file static class XmlCommentCache
    {
        ...
        private static Dictionary<string, XmlComment> GenerateCacheEntries()
        {
            ...
            cache.Add(@"P:BaseQuery.Name", new XmlComment(@"The full name of the person.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:DerivedQuery.Limit", new XmlComment(@"The maximum number of results to return.", null, null, null, null, false, null, null, null));
