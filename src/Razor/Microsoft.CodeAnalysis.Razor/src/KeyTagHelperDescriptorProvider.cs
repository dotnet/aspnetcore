...
namespace Microsoft.CodeAnalysis.Razor
{
    internal class KeyTagHelperDescriptorProvider : ITagHelperDescriptorProvider
    {
        ...
        public void Execute(TagHelperDescriptorProviderContext context)
        {
            ...
            if (targetAssembly != null && !SymbolEqualityComparer.Default.Equals(targetAssembly, renderTreeBuilderType.ContainingAssembly))
            {
                // If a target assembly is provided, only provide key tag helpers if we're inspecting the Microsoft.AspNetCore.Components assembly
