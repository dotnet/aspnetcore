...
{
    /// <summary>
    /// Represents properties and methods that are used by a Razor View for execution.
    /// </summary>
    public interface IRazorRazorPage<TOutputContext> where TOutputContext : IOutputContext
    {
        /// <summary>
        /// Gets or sets the view context of the rendering view.
        /// </summary>
        TOutputContext ViewContext { get; set; }
        ...
        /// <summary>
        /// Renders the page and writes the output to the <see cref="IOutputContext.Writer"/>.
        /// </summary>
