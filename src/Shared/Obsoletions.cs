...
internal sealed class Obsoletions
{
    ...
    internal const string TlsTokenBindingFeatureMessage = "ITlsTokenBindingFeature is deprecated. TLS Token Binding (RFC 8471) has been abandoned by browsers (Chrome/Edge).";
