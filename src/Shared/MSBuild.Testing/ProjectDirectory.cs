...
$@"<Project>
  <PropertyGroup>
    ...
    <BinariesRoot>{binariesRoot}</BinariesRoot>
                ...
                new List<string> { "Directory.Build.props", "Directory.Build.targets", "RazorTest.Introspection.targets", "blazor.webassembly.js", "Versions.props", "GenerateFiles.Directory.Build.props" }
                    .ForEach(file =>
                    {
