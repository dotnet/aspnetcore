...
public class ValidationOptions
{
    ...
    /// <see langword="null"/> for top-level minimal API parameters) and the ambient
    /// <see cref="IStringLocalizerFactory"/>. When not set, the localizer is created from the factory
    /// using the declaring type (or <see cref="object"/> when the type is <see langword="null"/>).
    /// </remarks>
