...
namespace Microsoft.AspNetCore.Server.Kestrel.Transport.Quic.Tests
{
    internal static class QuicTestHelpers
    {
        ...
        public static async Task<QuicStreamContext> CreateAndCompleteBidirectionalStreamGracefully(QuicConnection quicConnection, MultiplexedConnectionContext serverConnection)
        {
