...
/// <summary>
/// A factory for direct socket based connection contexts with OpenSSL integration.
/// </summary>
internal sealed class DirectSocketConnectionContextFactory : IDisposable
{
    private readonly DirectSocketConnectionFactoryOptions _options;
    ...
    public DirectSocketConnectionContextFactory(
        DirectSocketConnectionFactoryOptions options,
        ILogger logger,
        OpenSSLContext? sslContext = null)
    {
        ...
        if (_settingsCount > 0)
        {
            ...
            {
                var memoryPool = _options.MemoryPoolFactory?.Create(DefaultSimpleMemoryPoolFactory.MemoryPoolOptions) 
    ...
    public ConnectionContext Create(Socket socket)
    {
        ...
        var connection = new DirectSocketConnection(
            socket,
            setting.MemoryPool,
