...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal.Http2
{
    ...
    {
        public static bool EncodeHeaders(int statusCode, Http2HeadersEnumerator headersEnumerator, Span<byte> buffer, out int length)
        {
        ...
        public static bool EncodeHeaders(Http2HeadersEnumerator headersEnumerator, Span<byte> buffer, bool throwIfNoneEncoded, out int length)
        {
            var currentLength = 0;
            do
            {
