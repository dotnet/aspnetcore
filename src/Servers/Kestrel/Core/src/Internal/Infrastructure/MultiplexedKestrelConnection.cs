...
{
    internal class MultiplexedKestrelConnection : IConnectionHeartbeatFeature, IConnectionCompleteFeature, IConnectionLifetimeNotificationFeature, IThreadPoolWorkItem
    {
        ...
        private readonly MultiplexedConnectionDelegate _multiplexedConnectionDelegate;

        public MultiplexedKestrelConnection(long id,
                                 ServiceContext serviceContext,
                                 MultiplexedConnectionDelegate connectionDelegate,
                                 MultiplexedConnectionContext connectionContext,
                                 IKestrelTrace logger)
        {
            _id = id;
            _serviceContext = serviceContext;
            _multiplexedConnectionDelegate = connectionDelegate;
            Logger = logger;
        ...
        public MultiplexedConnectionContext TransportConnection { get; set; }
        ...
        internal async Task ExecuteAsync()
        {
            ...
            try
            {
                ...
                using (BeginConnectionScope(connectionContext))
                {
                    try
                    {
                        await _multiplexedConnectionDelegate(connectionContext);
                    }
                    catch (Exception ex)
                    {
        ...
        private IDisposable BeginConnectionScope(MultiplexedConnectionContext connectionContext)
        {
