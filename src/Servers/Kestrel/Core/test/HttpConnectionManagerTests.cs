...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Tests
{
    public class HttpConnectionManagerTests
    {
        ...
        //    var httpConnectionManager = new ConnectionManager(trace.Object);
        ...
        //    var httpConnection = new KestrelConnection(0, serviceContext, serviceContext.ConnectionManager, _ => Task.CompletedTask, mock.Object, Mock.Of<IKestrelTrace>());
