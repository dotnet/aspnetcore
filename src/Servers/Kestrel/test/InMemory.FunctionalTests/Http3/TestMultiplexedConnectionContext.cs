...
{
    internal class TestMultiplexedConnectionContext : MultiplexedConnectionContext, IProtocolErrorCodeFeature
    {
        ...
        {
            var inputPipeOptions = Http3TestBase.GetInputPipeOptions(_testBase._serviceContext, _testBase._memoryPool, PipeScheduler.ThreadPool);
            var outputPipeOptions = Http3TestBase.GetOutputPipeOptions(_testBase._serviceContext, _testBase._memoryPool, PipeScheduler.ThreadPool);
