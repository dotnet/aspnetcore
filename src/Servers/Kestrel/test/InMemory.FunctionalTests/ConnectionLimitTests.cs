...
public class ConnectionLimitTests : LoggedTest
{
    ...
    public async Task RejectsConnectionsWhenLimitReached()
    {
        ...
        using var rejectedConnections = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "rejected-connections");
