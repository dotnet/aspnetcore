...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Tests
{
    public class Http2StreamTests : Http2TestBase
    {
        ...
        public async Task ContentLength_Response_FirstWriteMoreBytesWritten_Throws_Sends500()
        {
            ...
            Assert.Contains(Messages, m => m.Exception?.Message.Contains("Response Content-Length mismatch: too many bytes written (12 of 11).") ?? false);
        ...
        public async Task ContentLength_Response_NoBytesWritten_Sends500()
        {
            ...
            Assert.Contains(Messages, m => m.Exception?.Message.Contains(CoreStrings.FormatTooFewBytesWritten(0, 11)) ?? false);
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public async Task ResponseTrailers_TooLong_Throws()
        {
            ...
            var message = Assert.Single(Messages, m => m.Exception is HPackEncodingException);
        ...
        public async Task ApplicationException_BeforeFirstWrite_Sends500()
        {
            ...
            Assert.Contains(Messages, m => (m.Exception?.Message.Contains("App Faulted") ?? false) && m.LogLevel == LogLevel.Error);
