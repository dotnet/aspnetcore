...
public class KestrelMetricsTests : TestApplicationErrorLoggerLoggedTest
{
    ...
    public async Task Http1Connection()
    {
        ...
        using var connectionDuration = new Extensions.Metrics.InstrumentRecorder<double>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "connection-duration");
        using var currentConnections = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "current-connections");
        using var queuedConnections = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "queued-connections");
    ...
    public async Task Http1Connection_Upgrade()
    {
        ...
        using var connectionDuration = new Extensions.Metrics.InstrumentRecorder<double>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "connection-duration");
        using var currentConnections = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "current-connections");
        using var currentUpgradedRequests = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "current-upgraded-connections");
    ...
    public async Task Http2Connection()
    {
        ...
        using var currentConnections = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "current-connections");
        using var queuedConnections = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "queued-connections");
        using var queuedRequests = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "queued-requests");
        using var tlsHandshakeDuration = new Extensions.Metrics.InstrumentRecorder<double>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "tls-handshake-duration");
        using var currentTlsHandshakes = new Extensions.Metrics.InstrumentRecorder<long>(new TestMeterRegistry(testMeterFactory.Meters), "Microsoft.AspNetCore.Server.Kestrel", "current-tls-handshakes");
