...
constexpr auto ASPNETCORE_DEBUG_FLAG_CONSOLE = 0x00000010;
constexpr auto ASPNETCORE_DEBUG_FLAG_FILE = 0x00000020;
constexpr auto ASPNETCORE_DEBUG_FLAG_EVENTLOG = 0x00000040;
