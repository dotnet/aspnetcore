...
internal class IISHttpContextOfT<TContext> : IISHttpContext where TContext : notnull
{
    ...
    public IISHttpContextOfT(MemoryPool<byte> memoryPool, IHttpApplication<TContext> application, IISHttpContextSafeHandle pInProcessHandler, IISServerOptions options, IISHttpServer server, ILogger logger, bool useLatin1)
