...
namespace Microsoft.AspNetCore.Server.HttpSys
{
    internal class RequestStream : Stream
    {
        ...
        {
            return ReadAsync(buffer, offset, count).ToIAsyncResult(callback, state);
        }
        ...
        public override unsafe Task<int> ReadAsync(byte[] buffer, int offset, int size, CancellationToken cancellationToken)
        {
            ...
            asyncResult = new RequestStreamAsyncResult(this, buffer, offset, dataRead, cancellationRegistration);
            uint bytesReturned;
