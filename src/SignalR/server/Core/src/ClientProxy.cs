...
namespace Microsoft.AspNetCore.SignalR
{
    ...
    public abstract class ClientProxy : IClientProxy
    {
        ...
        /// <summary>
        /// Invokes a method on the connection(s) represented by the <see cref="ClientProxy"/> instance.
        ...
        public abstract Task SendCoreAsync(string method, object[] args, CancellationToken cancellationToken = default);
    }
}
