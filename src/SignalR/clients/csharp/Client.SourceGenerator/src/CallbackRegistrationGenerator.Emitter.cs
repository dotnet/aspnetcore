...
namespace Microsoft.AspNetCore.SignalR.Client.SourceGenerator
{
    internal partial class CallbackRegistrationGenerator
    {
        public class Emitter
        {
            ...
            public void Emit()
            {
                if (string.IsNullOrEmpty(_spec.RegisterCallbackProviderClassAccessibility) ||
                    string.IsNullOrEmpty(_spec.RegisterCallbackProviderMethodAccessibility) ||
                    string.IsNullOrEmpty(_spec.RegisterCallbackProviderClassName) ||
                    string.IsNullOrEmpty(_spec.RegisterCallbackProviderMethodName) ||
                    string.IsNullOrEmpty(_spec.RegisterCallbackProviderTypeParameterName) ||
                    string.IsNullOrEmpty(_spec.RegisterCallbackProviderConnectionParameterName))
                {
                    return;
                }
            ...
            if(typeof({_spec.RegisterCallbackProviderTypeParameterName}) == typeof({fqtn}))
            {{
                return (System.IDisposable) new CallbackProviderRegistration({methodName}({_spec.RegisterCallbackProviderConnectionParameterName}, ({fqtn}) provider));
            }}");
                }
...
namespace {_spec.RegisterCallbackProviderNamespace}
{{
    {_spec.RegisterCallbackProviderClassAccessibility} static partial class {_spec.RegisterCallbackProviderClassName}
    {{
        {_spec.RegisterCallbackProviderMethodAccessibility} static partial System.IDisposable {_spec.RegisterCallbackProviderMethodName}<{_spec.RegisterCallbackProviderTypeParameterName}>(this HubConnection {_spec.RegisterCallbackProviderConnectionParameterName}, {_spec.RegisterCallbackProviderTypeParameterName} {_spec.RegisterCallbackProviderProviderParameterName})
        {{
{registerProviderBody.ToString()}
            throw new System.ArgumentException(nameof({_spec.RegisterCallbackProviderTypeParameterName}));
        }}
