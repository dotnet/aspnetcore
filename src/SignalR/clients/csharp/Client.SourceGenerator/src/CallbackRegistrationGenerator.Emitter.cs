    ...
    internal partial class CallbackRegistrationGenerator
    {
        public class Emitter
        {
            ...
            {{
                ...
                //  an array of IDisposables acquired from registration of each callback method from IHubConnection
...
{registerProviderBody.ToString()}
        ...
        {{
            ...
            private void EmitRegistrationMethod(TypeSpec typeSpec)
            {
                ...
                //  registers the method with IHubConnection and stashes the returned IDisposable into an array for
