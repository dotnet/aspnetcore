...
namespace Microsoft.AspNetCore.Http.Connections.Client
{
    ...
    public sealed class WebSocketConnectionContext
    {
        ...
        /// <param name="accessToken">The AccessToken to use.</param>
        public WebSocketConnectionContext(Uri uri, HttpConnectionOptions options, string? accessToken)
        {
            Uri = uri;
        ...
        /// <summary>
        /// Gets the AccessToken generated by <see cref="HttpConnectionOptions.AccessTokenProvider"/> function
        /// </summary>
