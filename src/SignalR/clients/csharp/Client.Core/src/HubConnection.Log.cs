    ...
    public partial class HubConnection
    {
        private static class Log
        {
            ...
            private static readonly Action<ILogger, string, string, string, string, Exception?> _issuingInvocation =
                LoggerMessage.Define<string, string, string, string>(LogLevel.Trace, new EventId(4, "IssuingInvocation"), "Issuing Invocation '{InvocationId}': {ReturnType} {MethodName}({Args}).", new LogDefineOptions() { SkipEnabledCheck = true });

            private static readonly Action<ILogger, string, string?, Exception?> _sendingMessage =
                LoggerMessage.Define<string, string?>(LogLevel.Debug, new EventId(5, "SendingMessage"), "Sending {MessageType} message '{InvocationId}'.", new LogDefineOptions() { SkipEnabledCheck = true });

            private static readonly Action<ILogger, string, string?, Exception?> _messageSent =
                LoggerMessage.Define<string, string?>(LogLevel.Debug, new EventId(6, "MessageSent"), "Sending {MessageType} message '{InvocationId}' completed.", new LogDefineOptions() { SkipEnabledCheck = true });
            ...
            private static readonly Action<ILogger, string?, string, string, Exception?> _receivedInvocation =
                LoggerMessage.Define<string?, string, string>(LogLevel.Trace, new EventId(8, "ReceivedInvocation"), "Received Invocation '{InvocationId}': {MethodName}({Args}).", new LogDefineOptions() { SkipEnabledCheck = true });
            ...
            private static readonly Action<ILogger, double, Exception?> _startingServerTimeoutTimer =
                LoggerMessage.Define<double>(LogLevel.Debug, new EventId(48, "StartingServerTimeoutTimer"), "Starting server timeout timer. Duration: {ServerTimeout:0.00}ms", new LogDefineOptions() { SkipEnabledCheck = true });
            ...
            private static readonly Action<ILogger, string, Exception?> _sendingMessageGeneric =
                LoggerMessage.Define<string>(LogLevel.Debug, new EventId(59, "SendingMessageGeneric"), "Sending {MessageType} message.", new LogDefineOptions() { SkipEnabledCheck = true });

            private static readonly Action<ILogger, string, Exception?> _messageSentGeneric =
                LoggerMessage.Define<string>(LogLevel.Debug, new EventId(60, "MessageSentGeneric"), "Sending {MessageType} message completed.", new LogDefineOptions() { SkipEnabledCheck = true });
