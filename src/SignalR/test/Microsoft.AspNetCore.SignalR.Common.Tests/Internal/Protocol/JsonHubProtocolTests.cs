...
namespace Microsoft.AspNetCore.SignalR.Common.Tests.Internal.Protocol
{
    ...
    public class JsonHubProtocolTests
    {
        ...
        public static IDictionary<string, JsonProtocolTestData> ProtocolTestData => new[]
        {
            ...
            new JsonProtocolTestData("InvocationMessage_HasStreamPlaceholder", new InvocationMessage(null, "Target", Array.Empty<object>(), new string[] { "__test_id__" }), true, NullValueHandling.Ignore, "{\"type\":1,\"target\":\"Target\",\"arguments\":[],\"streams\":[\"__test_id__\"]}"),
