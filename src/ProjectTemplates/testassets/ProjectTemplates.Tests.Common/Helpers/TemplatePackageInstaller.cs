...
namespace ProjectTemplates.Helpers
{
    internal static class TemplatePackageInstaller
    {
        ...
        public static string CustomHivePath { get; } = DefaultHivePath();
        public static string DefaultHivePath()
        {
            var attributes = typeof(TemplatePackageInstaller)
                .Assembly.GetCustomAttributes<AssemblyMetadataAttribute>();

            return attributes.Single(s => s.Key == "CustomTemplateHivePath").Value;
