...
#### Installing `dev` ProjectTemplates in local Visual Studio

1. Build the ProjectTemplates: `src\ProjectTemplates\build.cmd -pack -configuration Release`
...
3. Run Visual Studio, test out templates.
...
#### Running templates in a custom hive
