...
// Advertises where passkeys can be created and managed at /.well-known/passkey-endpoints so that
// credential managers can offer to upgrade a saved password to a passkey without the user having to
// find the page themselves. See https://w3c.github.io/webappsec-passkey-endpoints/.
