...
using BlazorWebWorker._1.WorkerClient;

namespace BlazorWebWorker._1.Pages;
...
public partial class ImageProcessor
{
    ...
    private async Task ApplyGrayscaleAsync()
    {
        ...
        try
        {
            ...
            var processedPixels = await WorkerClient.WorkerClient.InvokeAsync(
                "BlazorWebWorker._1.Worker.GrayscaleWorker.ApplyGrayscale",
                originalPixels,
                _intensity);
