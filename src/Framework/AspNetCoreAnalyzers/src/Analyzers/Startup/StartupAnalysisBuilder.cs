...
#pragma warning restore RS1024 // Compare symbols correctly
        ...
        lock (_lock)
        {
            return new StartupAnalysis(
                ...
                _analysesByType.ToImmutableDictionary(
                    ...
                    // Custom equality comparer as SymbolEqualityComparer.Default will upcast to ISymbol.
                    new NamedTypeSymbolEqualityComparer(SymbolEqualityComparer.Default)));
        }
    }
    ...
    private class NamedTypeSymbolEqualityComparer : IEqualityComparer<INamedTypeSymbol>
    {
        private readonly SymbolEqualityComparer _baseComparer;

        public NamedTypeSymbolEqualityComparer(SymbolEqualityComparer baseComparer)
        {
