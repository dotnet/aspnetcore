...
internal enum WellKnownType
{
    ...
    Microsoft_AspNetCore_Mvc_FromServicesAttribute,
    Microsoft_AspNetCore_Mvc_FromQueryAttribute,
    Microsoft_AspNetCore_Mvc_FromHeaderAttribute,
    Microsoft_AspNetCore_Mvc_FromRouteAttribute,
    Microsoft_AspNetCore_Mvc_FromFormAttribute,
    Microsoft_AspNetCore_Mvc_FromBodyAttribute,
