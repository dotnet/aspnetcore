...
internal static class DiagnosticDescriptors
{
    ...
    internal static readonly DiagnosticDescriptor AvoidAsyncVoidInMethodDeclaration = new(
        ...
        "Void as a return type in an async method is restricted for controller actions, razor page handler, filters, and signalr hub methods. Consider converting to 'async Task' or making the method synchronous by removing 'async' keyword",
        "Usage",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        helpLinkUri: "https://aka.ms/aspnet/analyzers");
