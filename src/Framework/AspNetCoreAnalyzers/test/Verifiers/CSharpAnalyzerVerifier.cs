    ...
    where TAnalyzer : DiagnosticAnalyzer, new()
{
    ...
    internal static ReferenceAssemblies GetReferenceAssemblies()
    {
        ...
        return net11Ref.AddAssemblies(ImmutableArray.Create(
            ...
            TrimAssemblyExtension(typeof(Microsoft.AspNetCore.Builder.RewriteBuilderExtensions).Assembly.Location),
            TrimAssemblyExtension(typeof(Microsoft.AspNetCore.Builder.StatusCodePagesExtensions).Assembly.Location),
            TrimAssemblyExtension(typeof(Microsoft.AspNetCore.Builder.ExceptionHandlerExtensions).Assembly.Location),
