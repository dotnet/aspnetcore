...
namespace Microsoft.AspNetCore.Authentication.JwtBearer
{
    ...
    public class JwtBearerEvents
    {
        ...
        /// <summary>
        /// Invoked if exceptions are thrown during the authorzation process.  The exceptions will be re-thrown after this event unless supressed.  
        /// </summary>
        public Func<AuthenticationFailedContext, Task> OnAuthorizationFailed { get; set; } = context => Task.CompletedTask;
        ...
        public virtual Task AuthorizationFailed(AuthenticationFailedContext context) => OnAuthorizationFailed(context);
