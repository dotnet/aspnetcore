...
internal static partial class LoggingExtensions
{
    ...
    [LoggerMessage(57, LogLevel.Debug, "PushAuthorization.HandledClientAuthentication", EventName = "PushAuthorizationHandledClientAuthentication")]
    public static partial void PushAuthorizationHandledClientAuthentication(this ILogger logger);

    [LoggerMessage(58, LogLevel.Debug, "PushAuthorization.HandledPush", EventName = "PushAuthorizationHandledPush")]
