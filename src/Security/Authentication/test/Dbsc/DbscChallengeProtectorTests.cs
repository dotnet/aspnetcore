...
public class DbscChallengeProtectorTests
{
    private static readonly TimeSpan s_lifetime = TimeSpan.FromMinutes(5);

    private static DbscChallengeProtector CreateProtector()
        => new(new EphemeralDataProtectionProvider(), NullLogger<DbscChallengeProtector>.Instance);
    ...
    public void ComputeClaimUid_PrefersSub_OverNameIdentifier()
    {
        ...
        Assert.Equal(DbscChallengeProtector.ComputeClaimUid(onlySub),
            DbscChallengeProtector.ComputeClaimUid(withSub));
    }
    ...
    public void ComputeClaimUid_UsesNameIdentifier_WhenNoSub()
    {
        ...
        Assert.Equal(DbscChallengeProtector.ComputeClaimUid(onlyNameId),
            DbscChallengeProtector.ComputeClaimUid(withNameId));
    }
    ...
    public void ComputeClaimUid_UsesUpn_WhenNoSubOrNameIdentifier()
    {
        ...
        Assert.False(string.IsNullOrEmpty(DbscChallengeProtector.ComputeClaimUid(onlyUpn)));
    }
}
