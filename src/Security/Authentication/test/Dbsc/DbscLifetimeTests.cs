...
public class DbscLifetimeTests
{
        ...
        Action<CookieAuthenticationOptions>? configureRefresh = null)
    {
            ...
            .ConfigureWebHost(webBuilder =>
            {
                webBuilder
                    ...
                    .ConfigureServices(services =>
                    {
                        ...
                        services.Configure<DbscOptions>(DbscScheme, options =>
                        {
                            options.TimeProvider = fakeTimeProvider;
                        });
        ...
        var dbscOptions = host.Services.GetRequiredService<IOptionsMonitor<DbscOptions>>();
