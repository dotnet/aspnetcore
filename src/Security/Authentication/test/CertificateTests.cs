...
public class ClientCertificateAuthenticationTests
{
    ...
    public void VerifyCacheNoOpsWithoutSchemeInHttpContextItems()
    {
        ...
        // Now set the scheme item ΓÇö Put and Get should work
