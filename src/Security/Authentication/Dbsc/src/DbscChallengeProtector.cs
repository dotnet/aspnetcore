...
internal sealed class DbscChallengeProtector
{
    ...
    private readonly ILogger<DbscChallengeProtector> _logger;

    public DbscChallengeProtector(IDataProtectionProvider dataProtectionProvider, ILogger<DbscChallengeProtector> logger)
    {
        _logger = logger;
        ...
        _registrationProtector = dataProtectionProvider
            .CreateProtector("Microsoft.AspNetCore.Authentication.Dbsc.Challenge.Registration.v1")
            .ToTimeLimitedDataProtector();
        _refreshProtector = dataProtectionProvider
            .CreateProtector("Microsoft.AspNetCore.Authentication.Dbsc.Challenge.Refresh.v1")
            .ToTimeLimitedDataProtector();
    }
