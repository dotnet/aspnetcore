...
/// </summary>
internal static partial class DbscLoggingExtensions
{
    // Refresh challenge validation (DbscChallengeProtector).
    ...
    // Registration endpoint (DbscHandler).
    ...
    // Proof JWT validation (DbscJwtValidator). All are routine rejections of a bad or
