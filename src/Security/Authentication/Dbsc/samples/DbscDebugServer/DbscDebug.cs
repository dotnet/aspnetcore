...
public static class DbscNames
{
    ...
    public const string Dbsc = "DBSC";
    public const string Refresh = Dbsc + ".Refresh";
    public const string Session = Dbsc + ".Session";

    public const string SourceCookie = ".AspNetCore.Application";
    public const string RefreshCookie = ".AspNetCore." + Dbsc + ".Refresh";
    public const string SessionCookie = ".AspNetCore." + Dbsc + ".Session";
    ...
    public const string RegistrationChallengePurpose = "Microsoft.AspNetCore.Authentication.Dbsc.Challenge.Registration.v1";
    public const string RefreshChallengePurpose = "Microsoft.AspNetCore.Authentication.Dbsc.Challenge.Refresh.v1";
