...
This project contains an implementation of OAuth 1a [Twitter Authentication](https://learn.microsoft.com/aspnet/core/security/authentication/social/twitter-logins) for ASP.NET Core.
