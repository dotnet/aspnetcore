...
namespace Microsoft.AspNetCore.SpaServices.AngularCli
{
    internal static class AngularCliMiddleware
    {
            ...
            string npmScriptName)
        {
            ...
            var angularCliServerInfoTask = StartAngularCliServerAsync(sourcePath, npmScriptName, spaBuilder.Options.PortNumber, logger);
        ...
        private static async Task<AngularCliServerInfo> StartAngularCliServerAsync(
            string sourcePath, string npmScriptName, int portNumber, ILogger logger)
        {
            if (portNumber == 0) {
