...
internal static partial class LoggerExtensions
{
    ...
    [LoggerMessage(12, LogLevel.Debug, "Vary by rules were updated. Headers: {HeaderNames}, Query keys: {QueryKeys}, Route values: {RouteValues}", EventName = "VaryByRulesUpdated")]
