...
internal static partial class LoggerExtensions
{
    ...
    [LoggerMessage(12, LogLevel.Error, "Unable to query output cache.", EventName = nameof(UnableToQueryOutputCache))]
    internal static partial void UnableToQueryOutputCache(this ILogger logger, Exception exception);

    [LoggerMessage(13, LogLevel.Error, "Unable to write to output-cache.", EventName = nameof(UnableToWriteToOutputCache))]
