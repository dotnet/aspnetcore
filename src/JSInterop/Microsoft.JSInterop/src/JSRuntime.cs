...
[assembly: MetadataUpdateHandler(typeof(JSRuntime.MetadataUpdateHandler))]
...
public abstract partial class JSRuntime : IJSRuntime, IDisposable
{
        ...
        object?[]? args)
    {
        ...
        try
        {
            ...
            var jsonSerializerOptions = GetJsonSerializerOptionsForResolver(resolver);
        ...
        JsonSerializerOptions GetJsonSerializerOptionsForResolver(IJsonTypeInfoResolver? resolver)
        {
            if (resolver is null)
            {
            ...
            if (!_cachedSerializerOptions.TryGetValue(resolver, out var options))
            {
                ...
                _cachedSerializerOptions[resolver] = options;
            }
    ...
    /// <summary>
    /// Clears all caches associated with this instance.
    /// </summary>
    internal void ClearCaches()
    {
        _cachedSerializerOptions.Clear();
    }
    ...
    private static void TrackJSRuntimeInstance(JSRuntime jsRuntime)
        => TrackedJSRuntimeInstances.All.Add(jsRuntime, null);

    internal static class TrackedJSRuntimeInstances
    {
        ...
        public static readonly ConditionalWeakTable<JSRuntime, object?> All = [];
    }
    ...
    internal static class MetadataUpdateHandler
    {
        ...
        {
            foreach (var (jsRuntime, _) in TrackedJSRuntimeInstances.All)
            {
                jsRuntime.ClearCaches();
            }
        }
    }
}
