...
namespace Microsoft.AspNetCore.Mvc.ViewFeatures
{
    ...
    public class HtmlHelperOptions
    {
        ...
        /// <summary>
        /// Gets or sets the CSS class name used to indicate that the value of the input field
        /// generated by <see cref="IHtmlHelper"/> is valid
        /// </summary>
        public string ValidationInputValidCssClassName { get; set; } = "input-validation-valid";

        /// <summary>
        /// Gets or sets the CSS class name used to indicate that the value of the input field
        /// generated by <see cref="IHtmlHelper"/> is invalid
        /// </summary>
        public string ValidationInputInvalidCssClassName { get; set; } = "input-validation-error";
        ...
        /// <summary>
        /// Gets or sets the CSS class name used to indicate that the top-level message generated
        /// by <see cref="IHtmlHelper.ValidationMessage"/> is valid
        /// </summary>
        public string ValidationMessageValidCssClassName { get; set; } = "field-validation-valid";

        /// <summary>
        /// Gets or sets the CSS class name used to indicate that the top-level message generated
        /// by <see cref="IHtmlHelper.ValidationMessage"/> contains errors
        /// </summary>
        public string ValidationMessageInvalidCssClassName { get; set; } = "field-validation-error";
        ...
        /// <summary>
        /// Gets or sets the CSS class name used to indicate that the top-level message generated
        /// by <see cref="IHtmlHelper.ValidationSummary"/> is valid
        /// </summary>
        public string ValidationSummaryValidCssClassName { get; set; } = "validation-summary-valid";

        /// <summary>
        /// Gets or sets the CSS class name used to indicate that the top-level message generated
        /// by <see cref="IHtmlHelper.ValidationSummary"/> contains errors
        /// </summary>
        public string ValidationSummaryInvalidCssClassName { get; set; } = "validation-summary-errors";
