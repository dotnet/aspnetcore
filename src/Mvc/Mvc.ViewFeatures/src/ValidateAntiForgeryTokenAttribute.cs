...
public class ValidateAntiForgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter, IValidateAntiforgeryMetadata
{
    /// <summary>
    ...
    bool IValidateAntiforgeryMetadata.ValidateIdempotentRequests => true;
