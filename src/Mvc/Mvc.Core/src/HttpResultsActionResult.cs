...
/// </summary>
public sealed class HttpResultsActionResult : ActionResult
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HttpResultsActionResult"/> class with the
    ...
    public HttpResultsActionResult(IResult result)
    {
        Result = result;
    }
