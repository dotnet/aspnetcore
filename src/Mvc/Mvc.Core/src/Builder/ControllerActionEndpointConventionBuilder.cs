...
public sealed class ControllerActionEndpointConventionBuilder : IEndpointConventionBuilder
{
    ...
    internal ControllerActionEndpointConventionBuilder(object @lock, List<Action<EndpointBuilder>> conventions, Stack<Action<EndpointBuilder>> finallyConventions)
    {
        _lock = @lock;
