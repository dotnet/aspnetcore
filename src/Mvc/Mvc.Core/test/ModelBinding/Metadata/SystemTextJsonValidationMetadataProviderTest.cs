...
public class SystemTextJsonValidationMetadataProviderTest
{
    ...
    public void CreateValidationMetadata_SetValidationPropertyName_WithJsonPropertyNameAttribute()
    {
        ...
        var key = ModelMetadataIdentity.ForProperty(typeof(SampleTestClass).GetProperty(nameof(SampleTestClass.NonAttributesProperty)), typeof(int), typeof(SampleTestClass));
    ...
    {
        var metadataProvider = new SystemTextJsonValidationMetadataProvider();
        var propertyName = nameof(SampleTestClass.NonAttributesProperty);
    ...
    {
        public int NonAttributesProperty { get; set; }
    }
}
