...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure
{
    public class DefaultPageLoaderTest
    {
        ...
        public async Task LoadAsync_InvokesApplicationModelProviders()
        {
            ...
            var endpointFactory = new ActionEndpointFactory(Enumerable.Empty<IRequestDelegateFactory>(), Mock.Of<RoutePatternTransformer>());
        ...
        public async Task LoadAsync_CreatesEndpoint_WithRoute()
        {
            ...
            var mvcOptions = Options.Create(new MvcOptions());
            var endpointFactory = new ActionEndpointFactory(Enumerable.Empty<IRequestDelegateFactory>(), transformer.Object);
