...
public class JsonPatchDocumentTest
{
    ...
    public void DoubleSlashAtBeginningShouldParseCorrectly()
    {
        ...
        var targetObject = new JsonObject { [""] = new JsonObject() };
        ...
        Assert.Equal(1, targetObject[""]["NewInt"].GetValue<int>());
    }
    ...
    public void DoubleSlashAtEndShouldParseCorrectly()
    {
        // Arrange
        var patchDocument = new JsonPatchDocument();
        var targetObject = new JsonObject { ["NewInt"] = new JsonObject { [""] = new JsonObject() } };
