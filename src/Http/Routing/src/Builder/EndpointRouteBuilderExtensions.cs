...
public static class EndpointRouteBuilderExtensions
{
        ...
        IReadOnlyList<object>? endpointMetadata = null)
    {
        ...
        var metadataToAdd = new List<object>();
        ...
        // This is added directly to the builder to ensure it's first in the metadata collection.
        builder.Metadata.Add(handler.Method);

        // Defer adding attributes on the handler to the call to RDF as those automatically generated by the
        // RDF have a higher specificity.
        ...
        if (attributes is not null)
        {
            foreach (var attribute in attributes)
            {
                metadataToAdd.Add(attribute);
            }
        }

        // Add additional metadata provided by caller
        if (endpointMetadata is not null)
        {
            metadataToAdd.AddRange(endpointMetadata);
        }
        ...
        routeHandlerBuilder.Add(endpointBuilder =>
        {
            var options = new RequestDelegateFactoryOptions
            {
                ...
                DefaultEndpointMetadata = metadataToAdd
            };
