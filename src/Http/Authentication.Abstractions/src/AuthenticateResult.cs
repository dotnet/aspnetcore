...
public class AuthenticateResult
{
    ...
    /// Indicates that there was a failure during authentication.
    /// </summary>
    /// <param name="failureMessage">The message that describes the authentication failure. This message is used to create an <see cref="AuthenticationFailureException"/>.</param>
    /// <returns>The result.</returns>
