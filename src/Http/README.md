...
- [Owin/](Owin/): Contains component for running OWIN middleware in an ASP.NET Core application, and to run ASP.NET Core middleware in an OWIN application.
...
- [WebUtilities/](WebUtilities/): Contains utilities, such as for working with forms, multipart messages, and query strings.
