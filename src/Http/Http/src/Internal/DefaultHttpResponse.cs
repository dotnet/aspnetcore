...
namespace Microsoft.AspNetCore.Http.Internal
{
    public class DefaultHttpResponse : HttpResponse
    {
        ...
        private readonly static Func<IFeatureCollection, IResponseBodyPipeFeature> _newResponseBodyPipeFeature = f => new ResponseBodyPipeFeature(f);
        ...
        {
            get { return ResponseBodyPipeFeature.PipeWriter; }
            set { ResponseBodyPipeFeature.PipeWriter = value; }
        }
