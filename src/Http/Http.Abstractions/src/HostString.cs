...
namespace Microsoft.AspNetCore.Http
{
    ...
    public readonly struct HostString : IEquatable<HostString>
    {
        ...
        /// </remarks>
        /// <returns><c>true</c> if <paramref name="value"/> matches any of the patterns.</returns>
        ...
        /// <returns><c>true</c> if they have the same value.</returns>
        ...
        /// <returns><c>true</c> if both <see cref="HostString"/>'s have the same value.</returns>
        ...
        /// <param name="left">The left parameter.</param>
        /// <param name="right">The right parameter.</param>
        /// <returns><c>true</c> if both <see cref="HostString"/>'s values are not equal.</returns>
        public static bool operator !=(HostString left, HostString right)
        {
            return !left.Equals(right);
        }
