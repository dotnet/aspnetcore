...
public static class EndpointHttpContextExtensions
{
    ...
    /// <returns>The <see cref="Endpoint"/> or <c>null</c> if the request doesn't have a set endpoint.</returns>
    /// <remarks>
    ...
    /// </summary>
    /// <param name="context">The <see cref="HttpContext"/> context.</param>
    /// <param name="endpoint">The <see cref="Endpoint"/>. A <c>null</c> value clears the set endpoint for the current request.</param>
