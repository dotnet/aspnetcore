...
namespace Microsoft.AspNetCore.WebUtilities
{
    ...
    /// </summary>
    public class FileBufferingPipeReaderStream : Stream
    {
        private const int _maxRentedBufferSize = 1024 * 1024; // 1MB
        private readonly MultipartSectionPipeReader _inner;
        ...
        /// </summary>
        /// <param name="inner">The wrapping <see cref="MultipartSectionPipeReader" />.</param>
        /// <param name="memoryThreshold">The maximum size to buffer in memory.</param>
        public FileBufferingPipeReaderStream(MultipartSectionPipeReader inner, int memoryThreshold)
            : this(inner, memoryThreshold, bufferLimit: null, tempFileDirectoryAccessor: AspNetCoreTempDirectory.TempDirectoryFactory)
        {
        }

        public FileBufferingPipeReaderStream(
            MultipartSectionPipeReader inner,
            int memoryThreshold,
            long? bufferLimit,
