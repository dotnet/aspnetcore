...
/// </summary>
public sealed partial class FileContent : IResult
{
    /// <summary>
    /// Creates a new <see cref="FileContent"/> instance with
    /// the provided <paramref name="fileContents"/> and the
    /// provided <paramref name="contentType"/>.
    /// </summary>
    /// <param name="fileContents">The bytes that represent the file contents.</param>
    /// <param name="contentType">The Content-Type of the file.</param>
    internal FileContent(ReadOnlyMemory<byte> fileContents, string? contentType)
    ...
    /// <summary>
    /// Creates a new <see cref="FileContent"/> instance with the provided values.
    /// </summary>
    /// <param name="fileContents">The bytes that represent the file contents.</param>
    /// <param name="contentType">The Content-Type of the file.</param>
    /// <param name="fileDownloadName">The suggested file name.</param>
