...
/// </summary>
public sealed partial class SignOut : IResult
{
    /// <summary>
    /// Initializes a new instance of <see cref="SignOut"/> with the default sign out scheme.
    /// </summary>
    internal SignOut()
    ...
    internal SignOut(AuthenticationProperties properties)
        : this(Array.Empty<string>(), properties)
    {
    }

    /// <summary>
    /// Initializes a new instance of <see cref="SignOut"/> with the
    /// specified authentication scheme.
    /// </summary>
    /// <param name="authenticationScheme">The authentication scheme to use when signing out the user.</param>
    internal SignOut(string authenticationScheme)
    ...
    internal SignOut(IList<string> authenticationSchemes)
    ...
    /// <param name="properties"><see cref="AuthenticationProperties"/> used to perform the sign-out operation.</param>
    internal SignOut(string authenticationScheme, AuthenticationProperties? properties)
    ...
    /// <param name="properties"><see cref="AuthenticationProperties"/> used to perform the sign-out operation.</param>
    internal SignOut(IList<string> authenticationSchemes, AuthenticationProperties? properties)
    {
