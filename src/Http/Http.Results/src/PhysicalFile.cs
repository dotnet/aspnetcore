...
/// <summary>
/// A <see cref="PhysicalFile"/> on execution will write a file from disk to the response
/// using mechanisms provided by the host.
/// </summary>
public sealed partial class PhysicalFile : IResult
{
    /// <summary>
    ...
    internal PhysicalFile(string fileName, string? contentType)
    ...
    /// <summary>
    /// Creates a new <see cref="PhysicalFile"/> instance with the provided values.
    /// </summary>
    /// <param name="fileName">The path to the file. The path must be an absolute path.</param>
    /// <param name="contentType">The Content-Type header of the response.</param>
    /// <param name="fileDownloadName">The suggested file name.</param>
