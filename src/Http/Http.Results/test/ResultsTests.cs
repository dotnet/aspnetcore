...
public partial class ResultsTests
{
    ...
    private static IEnumerable<(Expression<Func<IResult>>, Type)> FactoryMethodsTuples { get; } = new List<(Expression<Func<IResult>>, Type)>
    {
        ...
        (() => Results.BadRequest(), typeof(BadRequest)),
        (() => Results.BadRequest(null), typeof(BadRequest<object>)),
        ...
        (() => Results.Conflict(), typeof(Conflict)),
        (() => Results.Conflict(null), typeof(Conflict<object>)),
        ...
        (() => Results.NotFound(), typeof(NotFound)),
        (() => Results.NotFound(null), typeof(NotFound<object>)),
        (() => Results.NotFound(new()), typeof(NotFound<object>)),
        (() => Results.Ok(), typeof(Ok)),
        (() => Results.Ok(null), typeof(Ok<object>)),
        ...
        (() => Results.UnprocessableEntity(), typeof(UnprocessableEntity)),
        (() => Results.UnprocessableEntity(null), typeof(UnprocessableEntity<object>)),
