...
public partial class ResultsTests
{
    ...
    private static IEnumerable<(Expression<Func<IResult>>, Type)> FactoryMethodsTuples { get; } = new List<(Expression<Func<IResult>>, Type)>
    {
        ...
        (() => Results.BadRequest<object>(new(), null, null), typeof(BadRequest<object>)),
        ...
        (() => Results.InternalServerError<object>(new(), null, null), typeof(InternalServerError<object>)),
        ...
        (() => Results.NotFound<object>(new(), null, null), typeof(NotFound<object>)),
        (() => Results.Ok(), typeof(Ok)),
        (() => Results.Ok<object>(new(), null, null), typeof(Ok<object>)),
