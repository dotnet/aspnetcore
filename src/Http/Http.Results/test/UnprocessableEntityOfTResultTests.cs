...
public class UnprocessableEntityOfTResultTests
{
    ...
    [Fact]
    public async Task UnprocessableEntityObjectResult_WithProblemDetails_UsesDefaultsFromProblemDetailsService()
    {
        // Arrange
        var details = new ProblemDetails();
        var result = new UnprocessableEntity<ProblemDetails>(details);
        var stream = new MemoryStream();
        ...
        Assert.Equal(StatusCodes.Status422UnprocessableEntity, responseDetails.Status);
    ...
    [Fact]
    public async Task UnprocessableEntityObjectResult_WithProblemDetails_AppliesTraceIdFromService()
    {
        // Arrange
        var details = new ProblemDetails();
        var result = new UnprocessableEntity<ProblemDetails>(details);
    ...
    [Fact]
    public async Task UnprocessableEntityObjectResult_WithProblemDetails_FallsBackWhenServiceNotRegistered()
    {
        // Arrange
    ...
    [Fact]
    public async Task UnprocessableEntityObjectResult_WithHttpValidationProblemDetails_UsesDefaultsFromProblemDetailsService()
    {
        // Arrange
        var details = new HttpValidationProblemDetails();
        var result = new UnprocessableEntity<HttpValidationProblemDetails>(details);
        var stream = new MemoryStream();
        var services = CreateServiceCollection()
    ...
    [Fact]
    public async Task UnprocessableEntityObjectResult_WithNonProblemDetails_DoesNotUseProblemDetailsService()
    {
        // Arrange
        var details = new { error = "test error" };
        var result = new UnprocessableEntity<object>(details);
        var stream = new MemoryStream();
