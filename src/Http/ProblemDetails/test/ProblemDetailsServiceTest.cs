...
public class ProblemDetailsServiceTest
{
    ...
    public void IsEnable_ReturnsFalse_ForRouting_WhenDisable()
    {
        ...
        var service = CreateService(
            options: new ProblemDetailsOptions() { AllowedMapping = MappingOptions.ClientErrors | MappingOptions.Exceptions });
    ...
    public void IsEnable_ReturnsFalse_WhenUnspecified(int statuCode)
    {
        //Arrange
        var service = CreateService(
            options: new ProblemDetailsOptions() { AllowedMapping = MappingOptions.Unspecified });
    ...
    public void IsEnable_ReturnsFalse_ForSuccessStatus(int statuCode)
    {
        //Arrange
        var service = CreateService(
            options: new ProblemDetailsOptions() { AllowedMapping = MappingOptions.All });
    ...
    public void IsEnable_ReturnsTrue_ForClientErrors(int statuCode)
    {
        //Arrange
        var service = CreateService(
            options: new ProblemDetailsOptions() { AllowedMapping = MappingOptions.ClientErrors });
    ...
    public void IsEnable_ReturnsTrue_ForServerErrors(int statuCode)
    {
        //Arrange
        var service = CreateService(
            options: new ProblemDetailsOptions() { AllowedMapping = MappingOptions.Exceptions });
