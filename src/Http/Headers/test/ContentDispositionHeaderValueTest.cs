...
public class ContentDispositionHeaderValueTest
{
    ...
    public void Ctor_ContentDispositionValidFormat_SuccessfullyCreated()
    {
        ...
        Assert.Equal("inline".AsSpan(), contentDisposition.DispositionType);
    ...
    public void ContentDisposition_SetAndGetContentDisposition_MatchExpectations()
    {
        ...
        Assert.Equal("attachment".AsSpan(), contentDisposition.DispositionType);
    }
    ...
    public void Name_SetNameAndValidateObject_ParametersEntryForNameAdded()
    {
        ...
        Assert.Equal("myname".AsSpan(), contentDisposition.Name);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("name".AsSpan(), contentDisposition.Parameters.First().Name);
    ...
    public void Name_AddNameParameterThenUseProperty_ParametersEntryIsOverwritten()
    {
        ...
        Assert.Equal("new_name".AsSpan(), contentDisposition.Name);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("NAME".AsSpan(), contentDisposition.Parameters.First().Name);
    ...
    public void FileName_AddNameParameterThenUseProperty_ParametersEntryIsOverwritten()
    {
        ...
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("FILENAME".AsSpan(), contentDisposition.Parameters.First().Name);

        contentDisposition.FileName = "new_name";
        Assert.Equal("new_name".AsSpan(), contentDisposition.FileName);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("FILENAME".AsSpan(), contentDisposition.Parameters.First().Name);
    ...
    public void FileName_NeedsEncoding_EncodedAndDecodedCorrectly()
    {
        ...
        Assert.Equal("FileÃName.bat".AsSpan(), contentDisposition.FileName);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("filename".AsSpan(), contentDisposition.Parameters.First().Name);
        Assert.Equal("\"=?utf-8?B?RmlsZcODTmFtZS5iYXQ=?=\"".AsSpan(), contentDisposition.Parameters.First().Value);
    ...
    public void FileName_NeedsEncodingBecauseOfNewLine_EncodedAndDecodedCorrectly()
    {
        ...
        Assert.Equal("File\nName.bat".AsSpan(), contentDisposition.FileName);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("filename".AsSpan(), contentDisposition.Parameters.First().Name);
        Assert.Equal("\"=?utf-8?B?RmlsZQpOYW1lLmJhdA==?=\"".AsSpan(), contentDisposition.Parameters.First().Value);
    ...
    public void FileName_UnknownOrBadEncoding_PropertyFails()
    {
        ...
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("FILENAME".AsSpan(), contentDisposition.Parameters.First().Name);
        Assert.Equal("\"=?utf-99?Q?R=mlsZcODTmFtZS5iYXQ=?=\"".AsSpan(), contentDisposition.Parameters.First().Value);
        Assert.Equal("=?utf-99?Q?R=mlsZcODTmFtZS5iYXQ=?=".AsSpan(), contentDisposition.FileName);
    ...
    public void FileNameStar_AddNameParameterThenUseProperty_ParametersEntryIsOverwritten()
    {
        ...
        Assert.Equal("new_name".AsSpan(), contentDisposition.FileNameStar);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("FILENAME*".AsSpan(), contentDisposition.Parameters.First().Name);
        Assert.Equal("UTF-8\'\'new_name".AsSpan(), contentDisposition.Parameters.First().Value);
    ...
    public void FileNameStar_NeedsEncoding_EncodedAndDecodedCorrectly()
    {
        ...
        Assert.Equal("FileÃName.bat".AsSpan(), contentDisposition.FileNameStar);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("filename*".AsSpan(), contentDisposition.Parameters.First().Name);
        Assert.Equal("UTF-8\'\'File%C3%83Name.bat".AsSpan(), contentDisposition.Parameters.First().Value);
    ...
    public void NonValidAscii_WhenNeedsEncoding_UsesHex()
    {
        ...
        Assert.Equal($"UTF-8\'\'a%C2%80b".AsSpan(), contentDisposition.Parameters.First().Value); //%C2 added because the value in UTF-8 is encoded on 2 bytes.
    }
    ...
    public void LongValidAscii_FullyProcessedWithout()
    {
        ...
        Assert.Equal($"UTF-8\'\'{new string('a', 400)}".AsSpan(), contentDisposition.Parameters.First().Value);
    }
    ...
    public void FileNameStar_WhenNeedsEncoding_UsesHex()
    {
        ...
        foreach (byte b in Enumerable.Range(0, 128))
        {
                ...
                || b >= 0x7F)
            {
                ...
                Assert.Equal($"UTF-8\'\'a%{hexC}b".AsSpan(), contentDisposition.Parameters.First().Value);
            }
            else
            {
                Assert.Equal($"UTF-8\'\'a{(char)b}b".AsSpan(), contentDisposition.Parameters.First().Value);
            }
            contentDisposition.Parameters.Remove(contentDisposition.Parameters.First());
        }
    }
    ...
    public void FileNameStar_UnknownOrBadEncoding_PropertyFails()
    {
        ...
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("FILENAME*".AsSpan(), contentDisposition.Parameters.First().Name);
        Assert.Equal("utf-99'lang'File%CZName.bat".AsSpan(), contentDisposition.Parameters.First().Value);
        Assert.Null(contentDisposition.FileNameStar.Value); // Decode failure
    ...
    public void Dates_AddDateParameterThenUseProperty_ParametersEntryIsOverwritten()
    {
        ...
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("Creation-DATE".AsSpan(), contentDisposition.Parameters.First().Name);
        ...
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("Creation-DATE".AsSpan(), contentDisposition.Parameters.First().Name);
        Assert.Equal("\"Tue, 15 Nov 1994 08:12:32 GMT\"".AsSpan(), contentDisposition.Parameters.First().Value);
    ...
    public void Dates_InvalidDates_PropertyFails()
    {
        ...
        contentDisposition.Parameters.Add(dateParameter);
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("read-DATE".AsSpan(), contentDisposition.Parameters.First().Name);
    ...
    public void Size_AddSizeParameterThenUseProperty_ParametersEntryIsOverwritten()
    {
        ...
        Assert.Single(contentDisposition.Parameters);
        Assert.Equal("SIZE".AsSpan(), contentDisposition.Parameters.First().Name);
    ...
    public void FileNameWithSurrogatePairs_EncodedCorrectly()
    {
        ...
        Assert.Equal("File __ name.txt".AsSpan(), contentDisposition.FileName);
        Assert.Equal(2, contentDisposition.Parameters.Count);
        Assert.Equal("UTF-8\'\'File%20%F0%9F%A4%A9%20name.txt".AsSpan(), contentDisposition.Parameters[1].Value);
    }
