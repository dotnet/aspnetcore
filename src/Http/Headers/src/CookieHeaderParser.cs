...
namespace Microsoft.Net.Http.Headers
{
    internal sealed class CookieHeaderParser : HttpHeaderParser<CookieHeaderValue>
    {
        ...
        public bool TryParseValues(StringValues values, bool strict, Dictionary<string, string> store, bool enableCookieNameEncoding)
        {
            ...
            for (var i = 0; i < values.Count; i++)
            {
                ...
                while (!string.IsNullOrEmpty(value) && index < value.Length)
                {
                    ...
                    {
                        // TODO may need to revert here changes to the dictionary.
                        return false;
                    }
                    else
                    {
            ...
            // TODO currently parsing no values is the same as failing to parse.
            return true;
        }
        ...
        public override bool TryParseValue(StringSegment value, ref int index, out CookieHeaderValue? parsedValue)
        {
            ...
            index = current;
            parsedValue = new CookieHeaderValue(result.Value.Item1, result.Value.Item2);
            return true;
        }
