...
public sealed partial class ValidationsGenerator
{
    internal static void EmitValidationsFile(SourceProductionContext context, ((string Left, string Right) Left, ImmutableArray<string> Right) source)
    {
        ...
        output.StartBlock();
        output.WriteLine("[AttributeUsage(AttributeTargets.Method, AllowMultiple = true)]");
        ...
        output.WriteLine("using Microsoft.AspNetCore.Builder;");
        output.WriteLine("using System.Collections.Generic;");
        output.WriteLine("using Microsoft.AspNetCore.Http.Features;");
        output.WriteLine("using Microsoft.AspNetCore.Routing;");
