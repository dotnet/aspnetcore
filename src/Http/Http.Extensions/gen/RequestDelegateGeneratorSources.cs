...
{{GetThunks(thunks)}}
        ...
        private static ValueTask<(bool, T?)> TryResolveJsonBodyOrService<T>(HttpContext httpContext, bool isOptional)
        {
            var serviceProviderIsService = httpContext.RequestServices.GetService<IServiceProviderIsService>();
            ...
            return TryResolveBody<T>(httpContext, isOptional);
        }
    }
