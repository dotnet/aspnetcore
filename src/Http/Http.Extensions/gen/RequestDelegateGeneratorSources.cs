...
{{GetThunks(thunks)}}
        ...
        private static ValueTask<(bool, T?)> TryResolveJsonBodyOrService<T>(HttpContext httpContext, bool isOptional, IServiceProviderIsService? serviceProviderIsService = null)
        {
