...
namespace Microsoft.AspNetCore.Http.Validations.Generated
{
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "Rme9eOraTczInPnMR3QdwhwBAABQcm9ncmFtLmNz")]
        public static global::Microsoft.AspNetCore.Builder.IEndpointConventionBuilder WithValidation(this global::Microsoft.AspNetCore.Builder.IEndpointConventionBuilder builder)
        {
            builder.AddEndpointFilter(async (context, next) =>
            {
                ...
                var method = ((global::Microsoft.AspNetCore.Routing.RouteEndpoint)targetEndpoint).Metadata.GetMetadata<global::Microsoft.AspNetCore.Routing.IHttpMethodMetadata>().HttpMethods;
                Debug.Assert(route != null);
                var validationFilter = ValidationsFilters.Filters[new EndpointKey(route, method)];
    ...
    {
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate<T>(T value) => null;
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(ComplexType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null)
        {
            ...
            if (value != null)
            {
                ...
                var typePropertyWithMemberAttributesValidationResult = ValidationTypes.Validate(value?.PropertyWithMemberAttributes, validationContext);
                ...
                var typePropertyWithoutMemberAttributesValidationResult = ValidationTypes.Validate(value?.PropertyWithoutMemberAttributes, validationContext);
                ...
                var typePropertyWithInheritanceValidationResult = ValidationTypes.Validate(value?.PropertyWithInheritance, validationContext);
                ...
                {
                    var itemValidationResult = ValidationTypes.Validate(item, validationContext);
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(SubType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(SubTypeWithInheritance? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                ...
                {
                    var subTypeSubTypeValidationResult = ValidationTypes.Validate(subTypeSubType, validationContext);
            ...
            { new EndpointKey("/complex-type", ["POST"]), context => 
                {
                    ...
                    var value = context.GetArgument<ComplexType>(0);
                    global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? result = null;
                    var typeValidationResult = ValidationTypes.Validate(value, null);
                    if (typeValidationResult is not null)
                    {
                        foreach (var error in typeValidationResult.Errors)
                        {
                            (result ??= new()).Errors.Add(error.Key, error.Value);
                        }
                    }
                    return result;
                }
