...
namespace Microsoft.AspNetCore.Http.Validations.Generated
{
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "ee6EuWg61mjXrMPV0Uzud5EBAABQcm9ncmFtLmNz")]
        public static global::Microsoft.AspNetCore.Builder.IEndpointConventionBuilder WithValidation(this global::Microsoft.AspNetCore.Builder.IEndpointConventionBuilder builder)
        {
            builder.AddEndpointFilter(async (context, next) =>
            {
                ...
                var methods = ((global::Microsoft.AspNetCore.Routing.RouteEndpoint)targetEndpoint).Metadata.GetMetadata<global::Microsoft.AspNetCore.Routing.IHttpMethodMetadata>().HttpMethods;
    ...
    {
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate<T>(T value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool? callInDerived = false) => null;
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(SubType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ...
            if (value != null)
            {
                ...
                if (validationResult is not null && validationResult != global::System.ComponentModel.DataAnnotations.ValidationResult.Success)
                {
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(ValidatableSubType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                if (!calledInDerived && value is SubType subTypeSubType)
                {
                    var subTypeSubTypeValidationResult = ValidationTypes.Validate((SubType)subTypeSubType, validationContext);
                ...
                if (!resultBuilder.HasValue())
                {
                    ...
                    {
                        resultBuilder.WithError(validatableValidationResult.MemberNames.FirstOrDefault() ?? "ValidatableSubType", validatableValidationResult.ErrorMessage);
                    }
                }
            }
            return resultBuilder.HasValue() ? resultBuilder.Build() : null;
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(ComplexValidatableType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                ...
                validationContext.DisplayName = "SubType";
                validationContext.MemberName = "SubType";
                var typeSubTypeValidationResult = ValidationTypes.Validate(value?.SubType, validationContext);
                if (typeSubTypeValidationResult is not null)
                {
                    foreach (var error in typeSubTypeValidationResult.Errors)
                    {
                        resultBuilder.WithErrors($"SubType.{error.Key}", error.Value);
                    }
                }
                if (!resultBuilder.HasValue())
                {
                    ...
                    foreach (var validatableValidationResult in value.Validate(validationContext))
                    {
                        resultBuilder.WithError(validatableValidationResult.MemberNames.FirstOrDefault() ?? "ComplexValidatableType", validatableValidationResult.ErrorMessage);
                    }
                }
            }
            return resultBuilder.HasValue() ? resultBuilder.Build() : null;
    ...
    file static class ValidationsFilters
    {
        ...
        {
            { new EndpointKey("/validatable-object", ["POST"]), context => 
                {
                    ValidationProblemBuilder resultBuilder = new();
                    global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult = null;
                    var value0 = context.GetArgument<ComplexValidatableType>(0);
