...
namespace Microsoft.AspNetCore.Http.Validations.Generated
{
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "Ve9fVbKCj9TV9MAUJK8WnzABAABQcm9ncmFtLmNz")]
    ...
    file static class ValidationTypes
    {
        ...
        private static readonly ValidationAttribute Int32ValueRangeAttribute = new global::System.ComponentModel.DataAnnotations.RangeAttribute(10, 100);
        
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(RecursiveType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ...
            if (value != null)
            {
                ...
                validationResult = Int32ValueRangeAttribute.GetValidationResult(value.Value, validationContext);
                if (validationResult is not null && validationResult != global::System.ComponentModel.DataAnnotations.ValidationResult.Success)
                {
                    resultBuilder.WithError("Value", validationResult.ErrorMessage);
                }
                validationContext.DisplayName = "Next";
                validationContext.MemberName = "Next";
                var typeNextValidationResult = ValidationTypes.Validate(value?.Next, validationContext);
                if (typeNextValidationResult is not null)
                {
                    foreach (var error in typeNextValidationResult.Errors)
                    {
                        resultBuilder.WithErrors($"Next.{error.Key}", error.Value);
                    }
                }
            }
    ...
    file static class ValidationsFilters
    {
        ...
        {
            { new EndpointKey("/recursive-type", ["POST"]), context => 
                {
                    ValidationProblemBuilder resultBuilder = new();
                    global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult = null;
                    var value0 = context.GetArgument<RecursiveType>(0);
