...
namespace Microsoft.AspNetCore.Http.Validations.Generated
{
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "eD16JEJYD0uAb751t500n3gBAABQcm9ncmFtLmNz")]
    ...
    file static class ValidationTypes
    {
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(DerivedType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                if (!calledInDerived && value is BaseType subTypeBaseType)
                {
                    var subTypeBaseTypeValidationResult = ValidationTypes.Validate((BaseType)subTypeBaseType, validationContext);
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(BaseType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                if (value is DerivedType derivedTypeDerivedType)
                {
                    var derivedTypeDerivedTypeValidationResult = ValidationTypes.Validate(derivedTypeDerivedType, validationContext, calledInDerived: true);
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(DerivedValidatableType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                if (!calledInDerived && value is BaseValidatableType subTypeBaseValidatableType)
                {
                    var subTypeBaseValidatableTypeValidationResult = ValidationTypes.Validate((BaseValidatableType)subTypeBaseValidatableType, validationContext);
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(BaseValidatableType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                if (value is DerivedValidatableType derivedTypeDerivedValidatableType)
                {
                    var derivedTypeDerivedValidatableTypeValidationResult = ValidationTypes.Validate(derivedTypeDerivedValidatableType, validationContext, calledInDerived: true);
        ...
        public static global::Microsoft.AspNetCore.Http.HttpValidationProblemDetails? Validate(ContainerType? value, global::System.ComponentModel.DataAnnotations.ValidationContext? validationContext = null, IServiceProvider? serviceProvider = null, bool calledInDerived = false)
        {
            ValidationProblemBuilder resultBuilder = new();
            global::System.ComponentModel.DataAnnotations.ValidationResult? validationResult;
            if (value != null)
            {
                ...
                var typeBaseTypeValidationResult = ValidationTypes.Validate(value?.BaseType, validationContext);
                ...
                var typeBaseValidatableTypeValidationResult = ValidationTypes.Validate(value?.BaseValidatableType, validationContext);
