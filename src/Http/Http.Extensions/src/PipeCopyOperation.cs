...
namespace Microsoft.AspNetCore.Http.Extensions
{
    ...
    public static class PipeCopyOperation
    {
        ...
        /// <summary>Asynchronously reads the given number of bytes from the source stream and writes them using pipe writer, using a specified buffer size.</summary>
        /// <returns>A task that represents the asynchronous copy operation.</returns>
        /// <param name="source">The stream from which the contents will be copied.</param>
        /// <param name="writer"></param>
        /// <param name="count">The count of bytes to be copied.</param>
        ...
        /// <param name="cancel">The token to monitor for cancellation requests. The default value is <see cref="P:System.Threading.CancellationToken.None" />.</param>
        public static Task CopyToAsync(Stream source, PipeWriter writer, long? count, int bufferSize, CancellationToken cancel)
            => PipeCopyOperationInternal.CopyToAsync(source, writer, count, bufferSize, cancel);
    }
}
