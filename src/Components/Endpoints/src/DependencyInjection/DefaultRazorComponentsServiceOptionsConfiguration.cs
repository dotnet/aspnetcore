        ...
        if (file.Exists)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        var typeInfo = RazorComponentsServiceOptionsJsonContext.Default.StringArray;
                        var initializers = JsonSerializer.Deserialize(options.JavaScriptInitializers, typeInfo);
