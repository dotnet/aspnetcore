...
internal partial class EndpointHtmlRenderer : StaticHtmlRenderer, IComponentPrerenderer
{
        ...
        IFormCollection? form = null)
    {
        ...
        if (componentType != null)
        {
            ...
            var routingStateProvider = httpContext.RequestServices.GetService<EndpointRoutingStateProvider>();
            routingStateProvider!.SetRouteData(new RouteData(componentType, httpContext.GetRouteData().Values));
        }
    }
