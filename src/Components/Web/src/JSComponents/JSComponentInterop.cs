...
public class JSComponentInterop
{
    ...
    private static readonly IMaybeConcurrentDictionary<Type, ParameterTypeCache> ParameterTypeCaches = MaybeConcurrentDictionary.Create<Type, ParameterTypeCache>();
