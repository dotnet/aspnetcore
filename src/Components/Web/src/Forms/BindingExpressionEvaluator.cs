...
internal static class BindingExpressionEvaluator
{
        ...
        out object value)
    {
        ...
        // The chain could not be evaluated any deeper. The root of a binding expression is the component
        // instance, which no descriptor describes, so anchor at the model the edit context already holds.
