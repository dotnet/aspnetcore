...
{
    public override TResult GetInternalCalls<TResult>()
    {
        return (TResult)DefaultComponentsInternalCalls.Instance;
    }

    private IWebAssemblyInternalCalls ComponentsInternalCalls => GetInternalCalls<IComponentsInternalCalls>();
    ...
    /// <inheritdoc />
    protected internal override Task<Stream> ReadJSDataAsStreamAsync(IJSStreamReference jsStreamReference, long totalLength, CancellationToken cancellationToken = default)
