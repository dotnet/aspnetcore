...
internal sealed class HotReloadAgent : IDisposable
{
    ...
    private readonly AgentReporter Reporter = new();
    ...
    public IReadOnlyCollection<(string message, AgentMessageSeverity severity)> ApplyDeltas(IEnumerable<UpdateDelta> deltas, ResponseLoggingLevel loggingLevel)
    {
