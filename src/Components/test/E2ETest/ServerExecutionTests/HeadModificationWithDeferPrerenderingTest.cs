...
public class HeadModificationWithDeferPrerenderingTest : ServerTestBase<BasicTestAppServerSiteFixture<ComponentTagHelperWithDeferStartup>>
{
    public HeadModificationWithDeferPrerenderingTest(
        BrowserFixture browserFixture,
        BasicTestAppServerSiteFixture<ComponentTagHelperWithDeferStartup> serverFixture,
    ...
    {
        Navigate("/ComponentTagHelperWithDefer");
