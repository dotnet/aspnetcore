...
public class BindTest : ServerTestBase<ToggleExecutionModeServerFixture<Program>>
{
    ...
    public void CanBindTextbox_InitiallyBlank()
    {
        ...
        Assert.Equal(string.Empty, target.GetDomAttribute("value"));
        Assert.Equal(string.Empty, boundValue.Text);
        Assert.Equal(string.Empty, mirrorValue.GetDomAttribute("value"));
        ...
        Assert.Equal("Changed value", mirrorValue.GetDomAttribute("value"));

        // Remove the value altogether
        setNullButton.Click();
        Browser.Equal(string.Empty, () => target.GetDomAttribute("value"));
        Assert.Equal(string.Empty, boundValue.Text);
        Assert.Equal(string.Empty, mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextbox_InitiallyPopulated()
    {
        ...
        Assert.Equal("Hello", target.GetDomAttribute("value"));
        Assert.Equal("Hello", boundValue.Text);
        Assert.Equal("Hello", mirrorValue.GetDomAttribute("value"));
    ...
    public void CanBindTextboxInt()
    {
        ...
        Assert.Equal("-42", target.GetDomAttribute("value"));
        Assert.Equal("-42", boundValue.Text);
        Assert.Equal("-42", mirrorValue.GetDomAttribute("value"));

        // Clear target; value resets to zero
        target.Clear();
        Browser.Equal("0", () => target.GetDomAttribute("value"));
        Assert.Equal("0", boundValue.Text);
        Assert.Equal("0", mirrorValue.GetDomAttribute("value"));

        // Modify target; verify value is updated and that textboxes linked to the same data are updated
        // Leading zeros are not preserved
        target.SendKeys("42");
        Browser.Equal("042", () => target.GetDomAttribute("value"));
        target.SendKeys("\t");
        Browser.Equal("42", () => target.GetDomAttribute("value"));
        Assert.Equal("42", boundValue.Text);
        Assert.Equal("42", mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextboxNullableInt()
    {
        ...
        Assert.Equal("", mirrorValue.GetDomAttribute("value"));
    ...
    public void CanBindTextboxLong()
    {
        ...
        Assert.Equal("3000000000", target.GetDomAttribute("value"));
        Assert.Equal("3000000000", boundValue.Text);
        Assert.Equal("3000000000", mirrorValue.GetDomAttribute("value"));
        ...
        Browser.Equal("-3000000000", () => target.GetDomAttribute("value"));
        Assert.Equal("-3000000000", boundValue.Text);
        Assert.Equal("-3000000000", mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextboxNullableShort()
    {
        ...
        target.SendKeys("-42\t");
        Browser.Equal("-42", () => boundValue.Text);
        Browser.Equal("-42", () => mirrorValue.GetDomAttribute("value"));
    ...
    public void CanBindTextboxFloat()
    {
        ...
        Assert.Equal("3.141", target.GetDomAttribute("value"));
        Assert.Equal("3.141", boundValue.Text);
        Assert.Equal("3.141", mirrorValue.GetDomAttribute("value"));
        ...
        Browser.Equal("-3.141", () => target.GetDomAttribute("value"));
        Browser.Equal("-3.141", () => boundValue.Text);
        Browser.Equal("-3.141", () => mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextboxDouble()
    {
        ...
        Assert.Equal("3.14159265359", target.GetDomAttribute("value"));
        Assert.Equal("3.14159265359", boundValue.Text);
        Assert.Equal("3.14159265359", mirrorValue.GetDomAttribute("value"));
        ...
        Browser.Equal("0.01", () => target.GetDomAttribute("value"));
        Assert.Equal("0.01", boundValue.Text);
        Assert.Equal("0.01", mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextboxDecimal()
    {
        ...
        Assert.Equal("0.0000000000000000000000000001", target.GetDomAttribute("value"));
        Assert.Equal("0.0000000000000000000000000001", boundValue.Text);
        Assert.Equal("0.0000000000000000000000000001", mirrorValue.GetDomAttribute("value"));
        ...
        Assert.Equal("0.010", mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextboxNullableDecimal()
    {
        ...
        target.SendKeys("0.010\t");
        Browser.Equal("0.010", () => boundValue.Text);
        Browser.Equal("0.010", () => mirrorValue.GetDomAttribute("value"));
    ...
    public void CanBindTextbox_Decimal_InvalidInput()
    {
        ...
        target.SendKeys("2A");
        Assert.Equal("0.012A", target.GetDomAttribute("value"));
        target.SendKeys("\t");
        Browser.Equal("0.01", () => boundValue.Text);
        Browser.Equal("0.01", () => mirrorValue.GetDomAttribute("value"));
        Browser.Equal("0.01", () => target.GetDomAttribute("value"));
        ...
        Browser.Equal("0.02", () => mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextbox_NullableDecimal_InvalidInput()
    {
        ...
        Browser.Equal("0.01", () => boundValue.Text);
        Assert.Equal("0.01", mirrorValue.GetDomAttribute("value"));
        Assert.Equal("0.01", target.GetDomAttribute("value"));

        // Continue editing with valid inputs
        target.SendKeys(Keys.Backspace);
        target.SendKeys("2\t");
        Browser.Equal("0.02", () => boundValue.Text);
        Assert.Equal("0.02", mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextboxGenericGuid()
    {
        ...
        Assert.Equal("00000000-0000-0000-0000-000000000000", target.GetDomAttribute("value"));
        Assert.Equal("00000000-0000-0000-0000-000000000000", boundValue.Text);
        Assert.Equal("00000000-0000-0000-0000-000000000000", mirrorValue.GetDomAttribute("value"));
        ...
        Assert.Equal(newValue, mirrorValue.GetDomAttribute("value"));
    }
    ...
    public void CanBindTextboxDateTime()
    {
        ...
        Assert.Equal(expected, DateTime.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));

        // Clear textbox; value updates to 01/01/0001 because that's the default
        target.Clear();
        expected = default;
        Browser.Equal(expected, () => DateTime.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxDateTimeOffset()
    {
        ...
        Assert.Equal(expected, DateTimeOffset.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTimeOffset.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTimeOffset.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));

        // Clear textbox; value updates to 01/01/0001 because that's the default
        target.Clear();
        expected = default;
        Browser.Equal(expected, () => DateTimeOffset.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTimeOffset.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTimeOffset.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxDateOnly()
    {
        ...
        Assert.Equal(expected, DateOnly.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));

        // Clear textbox; value updates to 01/01/0001 because that's the default
        target.Clear();
        expected = default;
        Browser.Equal(expected, () => DateOnly.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxTimeOnly()
    {
        ...
        Assert.Equal(expected, TimeOnly.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));

        // Clear textbox; value updates to 00:00 because that's the default
        target.Clear();
        expected = default;
        Browser.Equal(expected, () => TimeOnly.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxDateTimeWithFormat()
    {
        ...
        var expected = new DateTime(1985, 3, 4);
        Assert.Equal("03-04", target.GetDomAttribute("value"));
        Assert.Equal(expected, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        ...
        target.SendKeys("\t");
        expected = default;
        Browser.Equal("01-01", () => target.GetDomAttribute("value"));
        Assert.Equal(expected, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxDateTimeOffsetWithFormat()
    {
        ...
        Assert.Equal(expected.DateTime, DateTimeOffset.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture).DateTime);
    }
    ...
    public void CanBindTextboxTimeOnlyWithFormat()
    {
        ...
        var expected = new TimeOnly(8, 5);
        Assert.Equal("08:05:00", target.GetDomAttribute("value"));
        Assert.Equal(expected, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        ...
        target.SendKeys("\t");
        expected = default;
        Browser.Equal("00:00:00", () => target.GetDomAttribute("value"));
        Assert.Equal(expected, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxNullableDateTime_InvalidValue()
    {
        ...
        Browser.Equal("05/06X", () => target.GetDomAttribute("value"));
        target.SendKeys("\t");
        Browser.Equal(expected, () => DateTime.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxDateTimeOffset_InvalidValue()
    {
        ...
        Browser.Equal("05/06X", () => target.GetDomAttribute("value"));
        target.SendKeys("\t");
        Browser.Equal(expected.DateTime, () => DateTimeOffset.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture).DateTime);
    ...
    public void CanBindTextboxDateTimeWithFormat_InvalidValue()
    {
        ...
        target.SendKeys(Keys.Control + "a"); // select all
        target.SendKeys("05/06");
        Browser.Equal("05/06", () => target.GetDomAttribute("value"));
        target.SendKeys("\t");
        Browser.Equal("03-04", () => target.GetDomAttribute("value"));
        Assert.Equal(expected, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxNullableTimeOnly_InvalidValue()
    {
        ...
        Browser.Equal("10:42:00X", () => target.GetDomAttribute("value"));
        target.SendKeys("\t");
        Browser.Equal(expected, () => TimeOnly.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTextboxTimeOnlyWithFormat_InvalidValue()
    {
        ...
        target.SendKeys(Keys.Control + "a"); // select all
        target.SendKeys("10:42");
        Browser.Equal("10:42", () => target.GetDomAttribute("value"));
        target.SendKeys("\t");
        Browser.Equal("08:05:00", () => target.GetDomAttribute("value"));
        Assert.Equal(expected, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(expected, TimeOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindMonthTextboxDateTime()
    {
        ...
        Assert.Equal(expected.AddDays(3), DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindMonthTextboxDateOnly()
    {
        ...
        Assert.Equal(expected.AddDays(3), DateOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTimeTextboxDateTime()
    {
        ...
        target.Clear();
        expected = default;
        Browser.Equal(DateTime.Now.Date, () => DateTime.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(default, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(default, DateTime.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindTimeTextboxTimeOnly()
    {
        ...
        target.Clear();
        expected = default;
        Browser.Equal(TimeOnly.MinValue, () => TimeOnly.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(default, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
        Assert.Equal(default, TimeOnly.Parse(mirrorValue.GetDomAttribute("value"), CultureInfo.InvariantCulture));
    ...
    public void CanBindDateTimeLocalDefaultStepTextboxDateTime()
    {
        ...
        target.Clear();
        expected = default;
        Browser.Equal(default, () => DateTime.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(default, DateTime.Parse(boundValue.Text, CultureInfo.InvariantCulture));
    ...
    public void CanBindTimeDefaultStepTextboxTimeOnly()
    {
        ...
        target.Clear();
        expected = default;
        Browser.Equal(default, () => TimeOnly.Parse(target.GetDomAttribute("value"), CultureInfo.InvariantCulture));
        Assert.Equal(default, TimeOnly.Parse(boundValue.Text, CultureInfo.InvariantCulture));
