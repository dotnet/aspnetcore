...
namespace Microsoft.AspNetCore.Components.WebView.Services
{
    ...
    ///
    /// </summary>
    internal sealed class WebViewJSDataStream : Stream
    {
        private readonly WebViewJSRuntime _runtime;
        ...
        {
            if (!runtime.WebViewJSDataStreamInstances.TryGetValue(streamId, out var instance))
            {
            ...
            CancellationToken cancellationToken)
        {
            ...
            _runtime.WebViewJSDataStreamInstances.Add(_streamId, this);
        ...
        public async Task<bool> ReceiveData(long chunkId, byte[] chunk, string error)
        {
            try
            {
                ...
                {
                    throw new InvalidOperationException($"An error occurred while reading the WebView stream: {error}");
                }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                _runtime.WebViewJSDataStreamInstances.Remove(_streamId);
            }
