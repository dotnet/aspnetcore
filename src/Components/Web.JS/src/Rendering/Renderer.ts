...
export function attachRootComponentToLogicalElement(browserRendererId: number, logicalElement: LogicalElement, componentId: number, append: boolean): void {
  ...
  browserRenderer.attachRootComponentToLogicalElement(componentId, logicalElement, append);
}

export function attachRootComponentToElement(elementSelector: string, componentId: number, append: boolean, browserRendererId?: number): void {
  ...
  attachRootComponentToLogicalElement(browserRendererId || 0, toLogicalElement(element, /* allow existing contents */ true), componentId, append);
}
