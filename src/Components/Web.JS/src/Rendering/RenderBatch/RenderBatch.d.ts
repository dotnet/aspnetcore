...
export interface ArrayRange<T> {
    ArrayRange__DO_NOT_IMPLEMENT: unknown;
}
export interface ArrayBuilderSegment<T> {
    ArrayBuilderSegment__DO_NOT_IMPLEMENT: unknown;
}
export interface ArrayValues<T> {
    ArrayValues__DO_NOT_IMPLEMENT: unknown;
}
export interface RenderTreeDiff {
    RenderTreeDiff__DO_NOT_IMPLEMENT: unknown;
}
export interface RenderTreeFrame {
    RenderTreeFrame__DO_NOT_IMPLEMENT: unknown;
}
export interface RenderTreeEdit {
    RenderTreeEdit__DO_NOT_IMPLEMENT: unknown;
}
