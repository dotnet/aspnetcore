...
import { toLogicalElement } from './LogicalElements';
...
export function attachRootComponentToLogicalElement(browserRendererId, logicalElement, componentId, appendContent) {
...
export function attachRootComponentToElement(elementSelector, componentId, browserRendererId) {
...
export function getRendererer(browserRendererId) {
    return browserRenderers[browserRendererId];
}
export function renderBatch(browserRendererId, batch) {
