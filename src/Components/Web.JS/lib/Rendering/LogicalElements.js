...
export function toLogicalRootCommentElement(start, end) {
...
export function toLogicalElement(element, allowExistingContents) {
...
export function removeLogicalChild(parent, childIndex) {
...
export function getLogicalParent(element) {
    return element[logicalParentPropname] || null;
}
export function getLogicalSiblingEnd(element) {
    return element[logicalEndSiblingPropname] || null;
}
export function getLogicalChild(parent, childIndex) {
...
export function getLogicalChildrenArray(element) {
    return element[logicalChildrenPropname];
}
export function permuteLogicalChildren(parent, permutationList) {
...
export function getClosestDomElement(logicalElement) {
