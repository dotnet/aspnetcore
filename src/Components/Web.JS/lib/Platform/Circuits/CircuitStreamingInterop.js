...
export function sendJSDataStream(connection, data, streamId, chunkSize) {
        ...
        try {
            ...
            while (position < byteLength) {
                ...
                if (numChunksUntilNextAck > 1) {
                    ...
                    const streamIsAlive = await connection.invoke('ReceiveJSDataChunk', streamId, chunkId, nextChunkData, null);
...
//# sourceMappingURL=CircuitStreamingInterop.js.map