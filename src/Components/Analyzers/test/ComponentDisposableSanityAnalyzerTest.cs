...
";
    ...
    // -------------------------------------------------------------------------
    // BL0015 – Dispose() without IDisposable
    // -------------------------------------------------------------------------

    [Fact]
    public void ComponentWithDisposeButWithoutIDisposable_ReportsBL0015()
    {
        var test = @"
    ...
    [Fact]
    public void ComponentThatImplementsIDisposableAndHasDispose_NoBL0015()
    {
        var test = @"
    namespace ConsoleApplication1
    {
    ...
    [Fact]
    public void NonComponentClassWithDisposeButWithoutIDisposable_NoBL0015()
    {
        var test = @"
    namespace ConsoleApplication1
    {
    ...
    [Fact]
    public void ComponentWithPrivateDisposeButWithoutIDisposable_NoBL0015()
    {
        var test = @"
    namespace ConsoleApplication1
    {
    ...
    // -------------------------------------------------------------------------
    // BL0016 – DisposeAsync() without IAsyncDisposable
    // -------------------------------------------------------------------------

    [Fact]
    public void ComponentWithDisposeAsyncButWithoutIAsyncDisposable_ReportsBL0016()
    {
        var test = @"
    namespace ConsoleApplication1
    {
    ...
    [Fact]
    public void ComponentThatImplementsIAsyncDisposableAndHasDisposeAsync_NoBL0016()
    {
        var test = @"
    namespace ConsoleApplication1
    {
    ...
    [Fact]
    public void NonComponentClassWithDisposeAsyncButWithoutIAsyncDisposable_NoBL0016()
    {
        var test = @"
    namespace ConsoleApplication1
    {
    ...
    [Fact]
    public void ComponentMissingBothInterfaces_ReportsBothBL0015AndBL0016()
    {
        var test = @"
    namespace ConsoleApplication1
    {
