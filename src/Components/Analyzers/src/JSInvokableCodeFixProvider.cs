...
{
    private static readonly LocalizableString _title = new LocalizableResourceString(nameof(Resources.JSInvokableMethodShouldBePublicStatic_FixTitle), Resources.ResourceManager, typeof(Resources));

    public override ImmutableArray<string> FixableDiagnosticIds
        => ImmutableArray.Create(new[]
        {
            DiagnosticDescriptors.JSInvokableMethodShouldBePublic.Id,
            DiagnosticDescriptors.JSInvokableMethodShouldBeStatic.Id,
        });
