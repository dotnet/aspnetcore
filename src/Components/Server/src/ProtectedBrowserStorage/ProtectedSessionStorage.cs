...
public sealed class ProtectedSessionStorage : ProtectedBrowserStorage
{
    ...
    internal ProtectedSessionStorage(IJSRuntime jsRuntime, IDataProtectionProvider dataProtectionProvider, JsonSerializerOptions serializerOptions, IServiceProvider services)
        : base("sessionStorage", jsRuntime, dataProtectionProvider, serializerOptions, services)
    {
    }
}
