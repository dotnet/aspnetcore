...
public sealed class ProtectedLocalStorage : ProtectedBrowserStorage
{
    ...
    internal ProtectedLocalStorage(IJSRuntime jsRuntime, IDataProtectionProvider dataProtectionProvider, JsonSerializerOptions serializerOptions, IServiceProvider services)
        : base("localStorage", jsRuntime, dataProtectionProvider, serializerOptions, services)
    {
    }
}
