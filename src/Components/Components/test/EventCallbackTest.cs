...
public class EventCallbackTest
{
    ...
    [Fact]
    public async Task EventCallbackOfT_InvokeAsync_IntArg()
    {
        // Arrange
        var component = new EventCountingComponent();
        ...
        int runCount = 0;
        int arg = 0;
        var callback = new EventCallback<int>(component, (Action<int>)((e) =>
        {
            arg = e;
            runCount++;
        }));
        ...
        // Act
        await callback.InvokeAsync(123);
    ...
    [Fact]
    public async Task EventCallbackOfT_InvokeAsync_GuidArg()
    {
        // Arrange
        var component = new EventCountingComponent();
        ...
        var callback = new EventCallback<Guid>(component, (Action<Guid>)((e) =>
        {
            arg = e;
            runCount++;
        }));
    ...
    [Fact]
    public async Task EventCallbackOfT_InvokeAsync_IntNullableArg()
    {
        // Arrange
        var component = new EventCountingComponent();
    ...
    [Fact]
    public async Task EventCallbackOfT_InvokeAsync_GuidNullableArg()
    {
        // Arrange
        var component = new EventCountingComponent();
