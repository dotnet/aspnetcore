...
//    {
//        // Arrange & Act
//        var routes = RouteTableFactory.Create(new RouteKey(GetType().Assembly, new[] { GetType().Assembly }), _serviceProvider);
...
//    {
//        // Arrange & Act
//        var routes = RouteTableFactory.Create(new List<Type> { typeof(MyComponent), }, _serviceProvider);
