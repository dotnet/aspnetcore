...
#endif
{
    ...
    public struct RenderTreeEdit
    {
        ...
        /// </summary>
        [FieldOffset(0)] public RenderTreeEditType Type;

        /// <summary>
        /// Gets the index of the sibling frame that the edit relates to.
        /// </summary>
        [FieldOffset(4)] public int SiblingIndex;
        ...
        /// </summary>
        [FieldOffset(8)] public int ReferenceFrameIndex;
        ...
        [FieldOffset(8)] public int MoveToSiblingIndex;
        ...
        /// </summary>
        [FieldOffset(16)] public string RemovedAttributeName;
