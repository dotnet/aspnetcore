...
public abstract partial class Renderer : IDisposable, IAsyncDisposable
{
    ...
    protected internal int AssignRootComponentId(IComponent component)
    {
        if (!_hotReloadInitialized)
        {
            ...
            if (HotReload.HotReloadManager.IsSupported && HotReloadManager != null && HotReloadManager.IsEnabled)
            {
    ...
    protected virtual void Dispose(bool disposing)
    {
        ...
        if (HotReload.HotReloadManager.IsSupported && HotReloadManager != null && HotReloadManager.IsEnabled && _hotReloadInitialized && _hotReloadRenderHandler is not null)
        {
            HotReloadManager.OnDeltaApplied -= _hotReloadRenderHandler.RerenderOnHotReload;
        }
