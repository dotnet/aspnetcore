...
namespace Microsoft.AspNetCore.Blazor.Services
{
    ...
    public class WebAssemblyUriHelper : UriHelperBase
    {
        ...
        protected override void InitializeState()
        {
            ...
            var baseUri = WebAssemblyJSRuntime.Current.Invoke<string>(Interop.GetBaseUri);
            var uri = WebAssemblyJSRuntime.Current.Invoke<string>(Interop.GetLocationHref);
        ...
        protected override void NavigateToCore(string uri, bool forceLoad)
        {
            ...
            WebAssemblyJSRuntime.Current.Invoke<object>(Interop.NavigateTo, uri, forceLoad);
        }
