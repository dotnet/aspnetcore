...
namespace Microsoft.AspNetCore.DataProtection
{
    ...
    /// </remarks>
    public sealed partial class EphemeralDataProtectionProvider : IDataProtectionProvider
    {
        ...
        public EphemeralDataProtectionProvider(ILoggerFactory loggerFactory)
        {
            ...
            Log.UsingEphemeralDataProtectionProvider(logger);
        ...
        private partial class Log
        {
            ...
            public static partial void UsingEphemeralDataProtectionProvider(ILogger logger);
        }
    }
}
