...
public class KeyRingProviderTests
{
    ...
    public void CreateCacheableKeyRing_NoGenerationRequired_DefaultKeyExpiresAfterRefreshPeriod()
    {
        ...
        // Act
        var cacheableKeyRing = keyRingProvider.GetCacheableKeyRing(now, allowShortRefreshPeriod: true);
    ...
    public void CreateCacheableKeyRing_GenerationRequired_NoDefaultKey_CreatesNewKeyWithImmediateActivation_NewKeyIsRevoked()
    {
        ...
        // Act/Assert
        Assert.Throws<InvalidOperationException>(() => keyRingProvider.GetCacheableKeyRing(now, allowShortRefreshPeriod: true)); // The would-be default key is revoked
    ...
    public void CreateCacheableKeyRing_GenerationRequired_NoDefaultKey_KeyGenerationDisabled_Fails()
    {
        ...
        // Act
        var exception = Assert.Throws<InvalidOperationException>(() => keyRingProvider.GetCacheableKeyRing(now, allowShortRefreshPeriod: true));
    ...
    public void RefreshWhenDefaultKeyIsNearExpiration_KeyGenerated(bool hasPropagated)
    {
        ...
        var keyRing = provider.GetCacheableKeyRing(now, allowShortRefreshPeriod: true);
