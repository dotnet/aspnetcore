...
{
    /// <summary>
    /// Bug: No DropCreateDatabaseIfModelChanges<MusicStoreEntities> yet. Need to inherit from it. 
    /// </summary>
    public class SampleData// : DropCreateDatabaseIfModelChanges<MusicStoreEntities>
    {
        ...
        /// <summary>
        /// Bug: This needs to be modified to the correct signature. protected override -> public void
        /// </summary>
        ...
        private static void AddAlbums(MusicStoreEntities context, string imgUrl, List<Genre> genres, List<Artist> artists)
        {
            ...
            for (int albumId = 0; albumId < context.Albums.Count; albumId++)
            {
                //Bug: albumId not populated due to lack of EF. 
                context.Albums[albumId].AlbumId = albumId + 1;
                context.Albums[albumId].GenreId = context.Albums[albumId].Genre.GenreId;
            }
        }
        ...
        private static List<Artist> AddArtists(MusicStoreEntities context)
        {
            ...
            //Bug: ForEach not found
            //artists.ForEach(s => context.Artists.Add(s));
            int artistId = 1;
            foreach (var artist in artists)
            {
                //Bug: ArtistId not populated automatically due to lack of EF. 
        ...
        private static List<Genre> AddGenres(MusicStoreEntities context)
        {
            ...
            {
                //Bug: GenreId not populated automatically due to lack of EF. 
