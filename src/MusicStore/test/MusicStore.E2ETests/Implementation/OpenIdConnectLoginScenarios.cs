...
namespace E2ETests
{
    public partial class Validator
    {
        public async Task LoginWithOpenIdConnect()
        {
            ...
            Assert.Contains(string.Format(CultureInfo.InvariantCulture, "Hello {0}!", "User3@aspnettest.onmicrosoft.com"), responseContent, StringComparison.OrdinalIgnoreCase);
