...
public class ComponentParametersShouldBePublicCodeFixProviderTest : CodeFixVerifier
{
    ...
    namespace ConsoleApplication1
    {
        ...
        class TypeName
        {
            ...
            [Parameter] protected internal string BadProperty2 { get; set; }
        }
        class TypeName2 : TypeName
        {
            [Parameter] protected new internal string BadProperty2 { get; set; }
        }
    }" + ComponentsTestDeclarations.Source;
        ...
        VerifyCSharpDiagnostic(test,
            ...
            new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                        new DiagnosticResultLocation("Test0.cs", 14, 55)
                }
            });
